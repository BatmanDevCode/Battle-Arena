...
Nux_fnc_setvector = compileFinal preprocessFile "TVS\scripts\vector.sqf";
...
_unit addAction ["<t color='#FFBD4C'>Guided Bombs ON</t>", "TVS\scripts\tvsaction.sqf",1,8,false,true,"","(player == gunner _target) or ((player == driver _target) and not (isPlayer gunner _target))"];
