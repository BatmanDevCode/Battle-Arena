...
systemchat "Holster Your Weapon With Key 5";
systemchat "Use Earplugs With Key 6 (Working But Small One Time Error - Will Fix)";
systemchat "Create A Group With Key U";
systemchat "Random Spawn Stuff With Scroll Wheel";
systemchat "Visit Shops To Get What You Want";